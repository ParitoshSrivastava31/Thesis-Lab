...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-primary text-white shadow hover:brightness-110",
        destructive:
          "bg-negative text-white shadow-sm hover:brightness-110",
        outline:
          "border border-bg-border bg-transparent shadow-sm hover:bg-bg-elevated hover:text-text-primary",
        secondary:
